...
@Component({
  ...
  templateUrl: './lista-pelicula.html',
  styleUrls: ['./lista-pelicula.css']
})
...
},
{
  ...
  duracion: 194,
  sinopsis: 'Una joven aristócrata conoce a un artista humilde en el Titanic, y juntos viven un romance breve e intenso que se ve interrumpido por la tragedia del hundimiento. La historia combina amor, desigualdad social y la catástrofe marítima más famosa de la historia moderna.',
...
},
{
  ...
  duracion: 127,
  sinopsis: 'Un parque temático que alberga dinosaurios clonados sufre un fallo de seguridad y los visitantes quedan atrapados en una pesadilla de supervivencia. La combinación de ambición científica desmedida y el poder de la naturaleza pone a prueba la capacidad humana de controlar lo incontrolable.',
...
},
{
  ...
  director: 'Wachowski',
  duracion: 136,
  sinopsis: 'Un hacker descubre que la realidad que conoce es una simulación creada por máquinas. Al unirse a la resistencia, debe aprender a liberar su mente y aceptar su papel como el elegido que puede cambiar el destino de la humanidad.',
...
},
{
  ...
  duracion: 142,
  sinopsis: 'Un hombre con un gran corazón y una perspectiva inocente vive acontecimientos clave de la historia de Estados Unidos, influyendo en ellos de formas inesperadas. Su vida, marcada por el amor, la amistad y la perseverancia, demuestra que cualquiera puede dejar huella en el mundo.',
...
},
{
  ...
  seleccionarPelicula(pelicula: Pelicula): void {
    ...
    this.router.navigate(['/funcion', pelicula.id], {
